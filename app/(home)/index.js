import { StyleSheet, Text, View, ScrollView, Pressable, TextInput, Alert, Image } from 'react-native'
  ...
  const CheckIfLocationEnabled = async () => {
    ...
    if(!enabled){
      Alert.alert(
        ...
        "Please enable your location services to continue", [{text:"OK"}], 
        { cancelable: false });
    }else{
  ...
  return (
    <ScrollView style={{flex:1, backgroundColor:"#f8f8f8"}}>
      ...
      marginHorizontal:10
        ...
        <TextInput placeholder="Search for food, hostels"/>
